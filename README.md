...
Портретная 2D roguelite tower-defense игра для браузера, Telegram Mini Apps и Android. Сейчас репозиторий содержит первый боевой прототип: неподвижный страж, автоматическая стрельба, враги сверху, тестовая волна, победа/поражение, пауза, настройки и версионированное локальное сохранение.
...
Текущие правила боя описаны в [`GAME_DESIGN.md`](GAME_DESIGN.md), а стартовые числа вынесены в `src/content/firstCombat.ts`.
...
Опыт, апгрейды, дополнительные враги и оружие, backend, авторизация и платежи будут добавляться следующими вертикальными срезами.
